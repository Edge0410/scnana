...
<div class="wrapper">
  ...
  <div class="main-wrapper">
    <div style="font-size: 20px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center;">Clasa a VI-a</div><br>
    <div class="image-cont" style="display: flex; width: 100%; position: relative; border: 3px double green; box-sizing: border-box;">
        <img src="Images/Clase/3. (a) Clasa a VI-a .jpg" style="width: 50%">
        <img src="Images/Clase/3. (b) Clasa a VI-a .jpg" style="width: 50%">
    ...
    <div style="font-size: 21px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; ">Evaluarea Națională clasele II, IV, VI</div><br>
    <a style="font-size: 15px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; padding: 4px; margin: auto; width: 100%; display: block;" href="Images/Clase/3. (c) 4946.pdf" download>OMEN nr. 4946 Evaluări naționale la finalul claselor II_IV_VI an școlar 2019-2020</a><br>
</div>
</div>
