...
<div class="wrapper">
  ...
  <div class="main-wrapper">
    <div style="font-size: 20px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center;">Clasa a VII-a</div><br>
    <div class="image-cont" style="display: flex; width: 100%; position: relative; border: 3px double green; box-sizing: border-box;">
        <img src="Images/Clase/4. (a) Clasa a VII-a.jpg" style="width: 50%">
        <img src="Images/Clase/4. (b) Clasa a VII-a.jpg" style="width: 50%">
