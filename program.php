...
<div class="wrapper">
  ...
  <div style="font-size: 25px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center;">PROGRAM</div><br>
    <div class="image-cont" style="display: block; width: 100%; position: relative;">
        <img src="Images/Prezentare/5  program (a) .jpg" style="border: 3px double green; width: 97%">
    ...
    <br>
    <div style="font-size: 20px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center;">ORAR</div><br>
    <div style="font-size: 20px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center; text-decoration: underline;">Faceți click pe imagine pentru zoom</div><br>
    <div class="image-cont" style="display: block; width: 80%; position: relative; box-sizing: border-box; margin: auto;">
        <img src="Images/Prezentare/5 program (b) .png" style="border: 3px double green; width: 100%; box-sizing: border-box;" onclick="showmodal2()">
    </div>
    <br>
    <div style="font-size: 20px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: initial;">&#10026; Structura anului școlar 2019-2020</div><br>
    <div style="font-size: 16px; color: rgb(0, 87, 0); margin: auto; font-weight: bold; text-align: initial;">&#10026; Semestrul I</div><br>
    <ul style="list-style: none; font-size: 15px; color: green; font-weight: bold; line-height: 1.6; font-family: sans-serif;">
        <li>&#9989; Cursuri: 9 septembrie - 20 decembrie 2019</li>
        <li>&#9989; Vacanță: 26 octombrie - 3 noiembrie 2019 (învățământ primar și preșcolar)</li>
        <li>&#9989; Vacanță de iarnă : 21 decembrie 2019 - 12 ianuarie 2020</li>
    </ul>
    <br>
    <div style="font-size: 16px; color: rgb(0, 87, 0); margin: auto; font-weight: bold; text-align: initial;">&#10026; Semestrul II</div><br>
    <ul style="list-style: none; font-size: 15px; color: green; font-weight: bold; line-height: 1.6; font-family: sans-serif;">
        <li>&#9989; Cursuri: 13 ianuarie - 3 aprilie 2020</li>
        <li>&#9989; Vacanță de primăvară: 4 - 21 aprilie 2020</li>
        <li>&#9989; Cursuri: 22 aprilie - 12 iunie 2020</li>
        <li>&#9989; Vacanță de vară: 13 iunie 2020 - data din septembrie 2020 la care vor începe cursurile anului școlar 2020-2021</li>
    </ul>
    <br>
    <div style="font-size: 16px; color: rgb(0, 87, 0); margin: auto; font-weight: bold; text-align: initial;">&#10026; Program secretariat cu publicul:</div><br>
    <ul style="list-style: none; font-size: 15px; color: green; font-weight: bold; line-height: 1.6; font-family: sans-serif;">
        <li>Luni-Vineri: 10:00 - 12:00</li>
        <li>Secretară: Neta Samuilă</li>
    </ul>
    <br>
    <div style="font-size: 16px; color: rgb(0, 87, 0); margin: auto; font-weight: bold; text-align: initial;">&#10026; Program bibliotecă:</div><br>
    <ul style="list-style: none; font-size: 15px; color: green; font-weight: bold; line-height: 1.6; font-family: sans-serif;">
        <li>Luni și marți 90:00 - 12:00</li>
        <li>Miercuri și joi: 10:00 - 14:00</li>
        <li>Vineri: 08:00 - 11:00</li>
    </ul>
  </div>
</div>
...
<div class="modal2 hidden">
    ...
    <div class="img-modal-cont">
        <img class="img-2" src="Images/Prezentare/5 program (b) .png">
    </div>
</div>
