...
<div class="wrapper">
  ...
  <div class="left-wrapper-noutati">
    ...
    <ul style="width: 100%; display: block; margin: auto; box-sizing: border-box; list-style-type: none; padding-inline-start: 0px;">
  ...
  <div class="main-wrapper">
    <div style="font-size: 22px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center;">OLIMPIADE / CONCURSURI ȘCOLARE</div><br>
    <div style="font-size: 16px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center;">An școlar 2019-2020</div><br>
    <div class="image-cont" style="display: flex; width: 100%; position: relative; border: 3px double green; box-sizing:border-box; ">
        <img src="Images/activitati scolare/1. Olimpiade, concursuri (a)  .jpg" style="width: 33%">
        <img src="Images/activitati scolare/1. Olimpiade, concursuri (b)  .jpg" style="width: 34%">
        <img src="Images/activitati scolare/1. Olimpiade, concursuri (c)  .jpg" style="width: 33%">
    ...
    <br>
    <div class="olimp-cont">
        <div class="olimp-button">
            Olimpiada de Limba și literatura română
        </div>
        <div class="olimp-prof hidden">
            Prof. coord. Militaru Aurel
        </div>
        <div class="olimp-faza hidden">
            <div class="faza-desc">
                Faza pe județ
            </div>
            <div class="flexbox-clase hidden">
                <div class="olimp-clasa">
                    <div class="clasa-button">
                        Clasa a V-a
                    </div>
                    
                    <ul class="olimp-elevi hidden">
                        <li>Ciobanu Ștefan - <span style="font-size: 17px; color: red;">Mentiune</span></li>
                        <li>Ciocârlie Alexandru - <span style="font-size: 17px; color: red;">Mentiune</span></li>
                    </ul>
                </div>
                <div class="olimp-clasa">
                    <div class="clasa-button">
                    ...
                    <ul class="olimp-elevi hidden">
                        <li>Savu Victor-Ștefan - <span style="font-size: 17px; color: red;">Premiul al II-lea</span></li>
                        <li>Drăgan Bianca - <span style="font-size: 17px; color: red;">Premiul al III-lea</span></li>
                        <li>Savu Alexandra-Maria - <span style="font-size: 17px; color: red;">Premiul al III-lea</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="olimp-faza hidden">
            ...
            <div class="flexbox-clase hidden">
                <div class="olimp-clasa">
                    ...
                    <ul class="olimp-elevi hidden">
                        <li>Stan Claudiu - <span style="font-size: 17px; color: red;">Mentiune</span></li>
                        <li>Zamfir Ciprian - <span style="font-size: 17px; color: red;">Mentiune</span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="olimp-cont">
        <div class="olimp-button">
            Concursul Național de Geografie „Terra”
        </div>
        <div class="olimp-prof hidden">
            Prof. coord. Dobre Florica
        </div>
        <div class="olimp-faza hidden">
            <div class="faza-desc">
                Faza pe județ
            ...
            <div class="flexbox-clase hidden">
                <div class="olimp-clasa">
                    ...
                    <ul class="olimp-elevi hidden">
                        <li>Arienescu Larisa - <span style="font-size: 17px; color: red;">Mentiune</span></li>
                        <li>Tudor Ecaterina - <span style="font-size: 17px; color: red;">Mentiune</span></li>
                    </ul>
                </div>
                <div class="olimp-clasa">
                    <div class="clasa-button">
                    ...
                    <ul class="olimp-elevi hidden">
                        <li>Ștolea Elena - <span style="font-size: 17px; color: red;">Premiul al III-lea</span></li>
                        <li>Ilie Cătălin - <span style="font-size: 17px; color: red;">Mențiune</span></li>
                    </ul>
                </div>
            </div>
        </div>
