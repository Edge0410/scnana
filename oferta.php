...
<div class="wrapper">
  ...
  <div class="main-wrapper">
    <div style="font-size: 25px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center;">OFERTA EDUCAȚIONALĂ</div><br>
    <div class="image-cont" style="display: block; width: 100%; position: relative;">
        <img src="Images/Prezentare/3 oferta educaționala .png" style="border: 3px double green; width: 100%">
    ...
    <br>
    <div style="font-size: 20px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: initial;">&#10026; Școala Gimnazială nr. 1 Nana pune la dispoziția elevilor următoarele:</div><br>
    <ul style="list-style: none; font-size: 15px; color: green; font-weight: bold; line-height: 1.6; font-family: sans-serif;">
        <li>&#9989; 18 săli de clasă</li>
        <li>&#9989; laborator de inforatică</li>
        <li>&#9989; spațiu de joacă în curtea școlii</li>
        <li>&#9989; amfiteatru pentru diverse activități și festivaluri</li>
        <li>&#9989; teren de sport</li>
        <li>&#9989; bibliotecă</li>
        <li>&#9989; 2 cancelarii</li>
        <li>&#9989; secretariat</li>
        <li>&#9989; compartimente administrative.</li>
    </ul>
    <br>
    <div style="font-size: 20px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: initial;">&#10026; Centralizator CDȘ pentru anul școlar 2020-2021:</div>
    <br>
    <table class="centralizator">
        <tr>
            <td>Nr. <br> crt.</td>
            <td>Denumirea opționalului</td>
            <td>Disciplina</td>
            <td>Clasa</td>
            <td>Profesor</td>
        </tr>
        ...
        <tr>
            <td>3.</td>
            <td>„Educație pentru sănătate”</td>
            <td>Biologie</td>
            <td>a VII-a</td>
            <td>Ion Vasile</td>
        </tr>
        <tr>
            <td>4.</td>
            <td>„Lectură prin teatru și film”</td>
            <td>Limba română</td>
            <td>a VIII-a</td>
            <td>Bobocea Geta</td>
        </tr>
