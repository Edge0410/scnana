...
<div class="wrapper">
  ...
  <div class="main-wrapper">
    <div style="font-size: 22px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center;">PROIECTE</div><br>
    ...
    <div class="image-cont" style="display: flex; width: 100%; position: relative; border: 3px double green; box-sizing: border-box;">
        <img src="Images/activitati scolare/3. Proiecte .jpg" style="width: 100%;">
    ...
    <br>
    <ul style="display: block; width: 100%; margin: auto; list-style-type: none; line-height: 1.6; font-family: sans-serif; font-size: 18px; font-weight: bold; color: black; padding-left: 0;">
        <li>&#10070; <span style="color: green; font-size: 20px;">„MICUL PIETON”</span> – Proiect Școala Gimnazială nr. 1 Nana</li>
        <li>&#10070; <span style="color: green; font-size: 20px;">„IMPLICĂ-TE ÎN STOPAREA VIOLENȚEI ÎN ȘCOLI”</span> - Proiect Școala Gimnazială nr. 1 Nana și Școala Gimnazială nr. 1 Luica</li>
        <li>&#10070; <span style="color: green; font-size: 20px;">„FENOMENUL BULLYING”</span> - Proiect Școala Gimnazială nr. 1 Nana și Școala Gimnazială „Lucian Pavel”, Oltenița</li>
        <li>&#10070; <span style="color: green; font-size: 20px;">„LA MULȚI ANI TUTUROR ROMÂNILOR!”</span> - Proiect Școala Gimnazială nr. 1 Nana</li>
        <li>&#10070; <span style="color: green; font-size: 20px;">„ÎMPREUNĂ PENTRU O LUME MAI BUNĂ”</span> - Proiect Școala Gimnazială nr. 1 Nana, Școala Gimnazială „Constantin Teodorescu” , Șoldanu și Școala Gimnazială nr. 1 Luica</li>
        <li>&#10070; <span style="color: green; font-size: 20px;">„UTILIZAREA CREATIVĂ, UTILĂ ȘI SIGURĂ A INTERNETULUI”</span> - Proiect Școala Gimnazială nr. 1 Nana</li>
        <li>&#10070; <span style="color: green; font-size: 20px;">CAMPANIA „DĂRUIND VEI DOBÂNDI”</span> - Proiect Școala Gimnazială nr. 1 Nana</li>
        <li>&#10070; <span style="color: green; font-size: 20px;">„MUȘUROIUL DE RECHIZITE”</span> - Proiect Școala Gimnazială nr. 1 Nana</li>
    </ul>
    <br>
  </div>
</div>
