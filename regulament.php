...
<div class="wrapper">
  ...
  <div style="font-size: 25px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center;">REGULAMENT</div><br>
    <div class="image-cont" style="display: flex; width: 100%; position: relative; border: 3px double green; box-sizing: border-box;">
        <img src="Images/Prezentare/4 regulament (a) .jpg" style="width: 33%">
        <img src="Images/Prezentare/4 regulament (b) .jpg" style="width: 34%">
        <img src="Images/Prezentare/4 regulament (c) .jpg" style="width: 33%">
    ...
    <br>
    <div style="font-size: 20px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: initial; text-indent: 20px; padding: 4px;">&#9989; Regulamentul de ordine interioară a Școlii Gimnaziale nr. 1 Nana a fost avizat în Consiliul de administrație din data de 07.10.2019 pentru anul școlar 2019-2020.</div>
    <br>
    <a style="font-size: 15px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center; padding: 4px; margin: auto; width: 100%; display: block;" href="#">Regulamentul de ordine interioară al Școlii Gimnaziale nr. 1 Nana - DOWNLOAD</a>
    <br>
    <div style="font-size: 20px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: initial; text-indent: 20px; padding: 4px;">&#9989; Alte regulamente școlare proprii:</div>
    <br>
    <a style="font-size: 15px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center; padding: 4px; margin: auto; width: 100%; display: block;" href="#">Regulamentul de Organizare și Funcționare al Școlii Gimnaziale nr. 1 Nana.</a>
    <a style="font-size: 15px; color: rgb(0, 167, 0); margin: auto; font-weight: bold; text-align: center; padding: 4px; margin: auto; width: 100%; display: block;" href="#">Codul de Etică și Conduită Profesională al Școlii Gimnaziale nr. 1 Nana.</a>
    <br>
</div>
</div>
